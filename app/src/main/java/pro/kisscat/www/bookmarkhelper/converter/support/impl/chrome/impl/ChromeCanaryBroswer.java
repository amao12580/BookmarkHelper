...
import pro.kisscat.www.bookmarkhelper.converter.support.impl.chrome.ChromeBroswerable;
...
public class ChromeCanaryBroswer extends ChromeBroswerable {
    ...
    public void fillDefaultAppName(Context context) {
        this.setName(context.getString(R.string.broswer_name_show_chrome_canary));
    }
    ...
    private static final String filePath_cp = Path.SDCARD_ROOTPATH + Path.SDCARD_APP_ROOTPATH + Path.SDCARD_TMP_ROOTPATH + "/ChromeCanary/";
